...
int main(void)
{
    ...
    while(1)
    {
    	...
    	if((SW_0==1)&&(SW_1==1))
    	{
        	if(BT_0 == 1)
        	{
        		counter_edge = counter_edge+1000 ;
        	}
        	else if(BT_1 == 1)
        	{
        		counter_edge = counter_edge - 1000;
    	...
    	if(counter_edge >= 1048576)
    	{
    		counter_edge = 1048576;
    	}
    	else if(counter_edge <= 0)
    	{
    		counter_edge = 0;
    	}
    	...
    	data_out = (counter_edge<<1) | (SW_0 & SW_1);
