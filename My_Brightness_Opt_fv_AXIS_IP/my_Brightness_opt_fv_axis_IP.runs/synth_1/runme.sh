...
HD_PWD='F:/Analog_Digital_Hackathons_2025/DH_Solutions/My_Brightness_Opt_fv_AXIS_IP/my_Brightness_opt_fv_axis_IP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_brightness_axis_ip_Wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_brightness_axis_ip_Wrapper.tcl
